        ...
        <form id="inform" action="../controller/updateCheckStudent.php" onsubmit="return validation()" method="post">
          ...
          <div class="form-set">
            ...
            <div class="form-group">
              ...
              <input type="text" id="mobile" name="mobile" value="<?php echo $updatemyinfo['mobile']; ?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter Student Mobile No" required="required">
